        ...
        <div class="col-xs-12 col-md-6 top-search-holder no-margin">
            <div class="contact-row">
                ...
                <div class="contact inline">
                    contact@<span class="le-color">oursupport.com</span>
                </div>
            </div><!-- /.contact-row -->
            <!-- ============================================================= SEARCH AREA ============================================================= -->
                    ...
                    <div class="basket">
                        ...
                        <a class="dropdown-toggle" data-toggle="dropdown" href="#">
                            <div class="basket-item-count">
                                <span class="count"><?=$_SESSION['cart_products_rows'];?></span>
                            ...
                            <div class="total-price-basket">
                                ...
                                <span class="total-price">
                                    <span class="value"><?=$_SESSION['cart_price'];?>.00 грн.</span>
                                </span>
                            </div>
                        </a>
                        ...
                        <ul class="dropdown-menu">
                            <?  
                                $_SESSION['cart_all_products'] = array();
                                                    ...
                                                    <div class="basket-item">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-xs-8 col-sm-8 no-margin">
                                                                ...
                                                                <div class="price">'.$row[0]['price'].'.00</div>
                                                            </div>
                                                        </div>
                                ...
                                if(empty($_SESSION['cart_all_products'])) {
                                    echo "<h4 style='text-align: center;'>Корзина пуста!</h4>";
                                } else {
                                    for ($i=0; $i < count($_SESSION['cart_all_products']); $i++) { 
                                        echo $_SESSION['cart_all_products'][$i];
                                    }
                                }
                            ?>
                                ...
                                <div class="basket-item">
                                    <div class="row">
                                        <div class="col-xs-12 col-sm-6">
                                            <a href="../cart.php" class="le-button">Корзина</a>
                                        </div>
                                        <div class="col-xs-12 col-sm-6">
                                            <a href="../checkout.php" class="le-button">Оформить</a>
                                        </div>
                                    </div>
                                </div>
                            </li>
            ...
            <div class="yamm navbar">
                ...
                <div class="collapse navbar-collapse" id="mc-horizontal-menu-collapse">
                    <ul class="nav navbar-nav">
                        <li class="dropdown">
                            <a href="#" class="dropdown-toggle" data-hover="dropdown" data-toggle="dropdown">Бижутерия</a>
                            <ul class="dropdown-menu">
                                <li><a href="category.php?category=Серьги">Серьги</a></li>
                                <li><a href="category.php?category=Колье">Колье</a></li>
                                <li><a href="category.php?category=Браслеты">Браслеты</a></li>
                                <li><a href="category.php?category=Кулоны">Кулоны</a></li>
                                <li><a href="category.php?category=Комплекты">Комплекты</a></li>
                            </ul>
                        </li>

                        <li class="dropdown">
                            <a href="#" class="dropdown-toggle" data-hover="dropdown" data-toggle="dropdown">Солнцезащитные очки</a>
                            <ul class="dropdown-menu">
                        ...
                        <li class="dropdown">
                            <a href="#" class="dropdown-toggle" data-hover="dropdown" data-toggle="dropdown">Зонты</a>
                        </li>

                        <li class="dropdown">
                            <a href="#" class="dropdown-toggle" data-hover="dropdown" data-toggle="dropdown">Оптические очки</a>
                        </li>
                    </ul><!-- /.navbar-nav -->
                </div><!-- /.navbar-collapse -->
            </div><!-- /.navbar -->
